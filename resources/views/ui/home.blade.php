              ...
              <div class="detail-box">
                <div>
                  ...
                  <h5 class="mt-4 fw-bold" style="font-family: 'Bangers', cursive; color:rgb(14, 47, 48) ">
                    စူးစမ်းချင်စိတ်ကို တိုးပွားစေပြီး သင်ယူမှုကို ဂုဏ်ပြုသော နည်းပညာဖြင့် ပံ့ပိုးထားသော
                    အသိပညာရှာဖွေမှုကို အတူတကွ စတင်လိုက်ကြပါစို့
                  </h5>
                  <div class="">
                    <a href="{{route('login')}}">
            ...
            <div class="container">
              ...
              <div class="do_container">
                <div class="box arrow-start arrow_bg">
                  <div class="img-box">
                    <img class="rounded-circle" src="{{asset('ui-images/download.jpg')}}"
